...
var LeaderLine = (function() {
                    ...
                    k.forEach(function(e) {
                        ...
                        if (e.framesStart) {
                            ...
                            e.reverse && (t = e.duration - t),
                                (a = e.frames[(e.lastFrame = Math.round(t / b))]), !1 !== e.frameCallback(a.value, !1, a.timeRatio, a.outputRatio) ?
                                (o = !0) :
                                (e.framesStart = null);
                        }
                    }),
            ...
            return {
                            ...
                            return (
                                ...
                                (n ?
                                    ...
                                    ((a = (Date.now() - e.framesStart) / e.duration),
                                        e.reverse && (a = 1 - a),
                                        a < 0 ? (a = 0) : 1 < a && (a = 1)), !(e.framesStart = null))
                            );
                        }),
                        a
                    );
                ...
                validTiming: function(t) {
                    return 'string' == typeof t ?
                        x[t] :
                        Array.isArray(t) && [0, 1, 2, 3].every(function(e) {
                ...
                o.prototype = {
                    ...
                    _parseNumber: function() {
                        ...
                        if (
                            ...
                            return null;
                        for (
                            var r = this._currentIndex; this._currentIndex < this._endIndex &&
            ...
            function(e, t, n) {
                ...
                var p = {
                    ...
                    remove: function(e) {
                        var t; -
                        1 < (t = h(e)) &&
                            (i.splice(t, 1), !i.length && r && (l.call(window, r), (r = null)));
                    },
                };
                t.default = p;
            },
    ...
    function fe(e) {
        ...
        return (
            ...
            'transparent' === e.toLocaleLowerCase() && (i = 0), [i, o]
        );
    }
    ...
    function be(n, a, i, o, e) {
        ...
        var r,
            ...
            d = 0;
        return (
            (r = (e = null == e || 1 < e ? 1 : e < 0 ? 0 : e) / 2), [-0.1252,
                0.1252, -0.3678,
                0.3678, -0.5873,
                0.5873, -0.7699,
                0.7699, -0.9041,
            ...
            ((E.position_path = g.path),
                ...
                (f = [0, 1].map(function(e) {
                    var t,
                        ...
                        s = !1 !== o && l.conf.getBBoxNest ?
                        l.conf.getBBoxNest(l, u, r) :
                        ge(i, u.baseWindow);
                    return (
                        (E.capsMaskAnchor_pathDataSE[e] = !1 !== o && l.conf.getPathData ?
                ...
                E.position_lineStrokeWidth !== x.position_lineStrokeWidth || [0, 1].some(function(e) {
                    return (
        ...
        t.line &&
            ...
            (ee.faces =
                ((b = (E = e).curStats),
                    ...
                    b.plug_enabled && [0, 1].forEach(function(n) {
                        ...
                        We(
                            ...
                            (We(E, k.plug_plugSE, n, e, w.apl_plug_plugSE) &&
                                ...
                                ((E.plugFaceSE[n].style.fill = x),
                                    ...
                                    (se || ue || le) &&
                                    !b.line_colorTra &&
                                    Ae(E, le ? E.lineMaskCaps : E.capsMaskLine)), ['markerWidth', 'markerHeight'].forEach(function(e) {
                                    var t = 'plug_' + e + 'SE';
                                ...
                                (We(
                                    ...
                                    ((E.plugOutlineFaceSE[n].href.baseVal = E.plugMaskShapeSE[
                                            ...
                                            n
                                        ].href.baseVal = '#' + t.elmId), [E.plugMaskSE[n], E.plugOutlineMaskSE[n]].forEach(
                                            function(e) {
            ...
            (ee.viewBox =
                ((B = (N = e).curStats),
                    ...
                    (G.width = W.x2 - W.x1),
                    (G.height = W.y2 - W.y1), ['x', 'y', 'width', 'height'].forEach(function(e) {
                        var t;
                        (t = G[e]) !== D[e] &&
                            ((z[e] = D[e] = t),
                                (j[oe[e]] =
                    ...
                    (We(U, X, 'lineMask_outlineMode', (Z = Y.lineMask_outlineMode)) &&
                        ...
                        ([0, 1].forEach(function(e) {
                            ...
                            ((U.capsMaskLine.style.display = Z ? 'inline' : 'none'),
                                (q = !0)),
                            Y.capsMaskMarker_enabled && [0, 1].forEach(function(n) {
                                ...
                                We(
                                    ...
                                    (We(U, X.capsMaskMarker_plugSE, n, e) &&
                                        ((U.capsMaskMarkerShapeSE[n].href.baseVal =
                                            ...
                                            (q = !0),
                                            re && (Ae(U, U.capsMaskLine), Ae(U, U.lineFace))), ['markerWidth', 'markerHeight'].forEach(function(e) {
    ...
    function He(e, t, n) {
        ...
        return (!(!(e.attachments.indexOf(t) < 0) ||
    ...
    function Ze(s, u) {
        ...
        if (
            ((u = u || {}), ['start', 'end'].forEach(function(e, t) {
                var n = u[e],
                    a = !1;
        ...
        i &&
            (e = (function(e, t) {
                ...
                h.anchorSE[0], !1 !== s.optionIsAttach.anchorSE[1] ?
            ...
            (!(function(a, e) {
                    ...
                    function y(e) {
                        ...
                        return (
                            (t.id = e),
                            (t.maskUnits.baseVal = SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE), [t.x, t.y, t.width, t.height].forEach(function(e) {
                    ...
                    Te(c, Y),
                        ...
                        d.body.appendChild(t), [0, 1, 2].forEach(function(e) {
                            var t,
                ...
                null != e &&
                    (Array.isArray(e) ?
                        ...
                        ((e + '').toLowerCase() === x ?
                            (i = null) :
                            w(e) && 0 <= e && (i = e),
                            i === h.socketGravitySE[t] && (i = !1)), !1 !== i && ((h.socketGravitySE[t] = i), (p.position = !0)));
            }),
            (p.line =
                    ...
                    if (
                        ...
                        if (
                            (r ?
                                ...
                                (i = new S(y.captionLabel, [o])), !He(s, $[i._id], e))
                        )
                            throw new Error("Can't bind attachment");
                        h.labelSEM[t] = i;
                    }
    ...
    return (
            ...
            gradient: {
                ...
                init: function(e) {
                    ...
                    (t.gradientUnits.baseVal =
                        SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE), [t.x1, t.y1, t.x2, t.y2].forEach(function(e) {
                            e.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX, 0);
                        }),
                ...
                update: function(a) {
                    ...
                    [0, 1].forEach(function(e) {
                        ...
                        (i.gradient_pointSE[1] = { x: t.x, y: t.y }), [0, 1].forEach(function(t) {
                            var n;
                            We(a, o.gradient_colorSE, t, (n = i.gradient_colorSE[t])) &&
                                (ue ?
                                    ...
                                    (a.efc_gradient_stopSE[t].style.stopColor = n)), ['x', 'y'].forEach(function(e) {
        ...
        (y = {
            pointAnchor: {
                ...
                init: function(e, t) {
                    return (
                        ...
                        (e.y = y.pointAnchor.parsePercent(t.y, !0) || [0.5, !0]), !0
                    );
                },
                ...
                init: function(i, e) {
                    ...
                    return (
                        ...
                        e.points.every(function(e) {
                            var t = {};
                            return (!(!(t.x = y.pointAnchor.parsePercent(e[0], !0)) ||
                ...
                init: function(a, i) {
                    ...
                    return (
                        (d.style.backgroundSize =
                            d.backgroundSize.width + 'px ' + d.backgroundSize.height + 'px'), ['style', 'hoverStyle'].forEach(function(e) {
                            var n = d[e];
            ...
            captionLabel: {
                ...
                init: function(u, t) {
                    return (
                        'string' == typeof t.text && (u.text = t.text.trim()), !!u.text &&
                            ...
                            (u.adjustEdge = function(e, t) {
                                ...
                                null != n.x &&
                                    y.captionLabel.adjustEdge(
                                        t, { x: n.x, y: n.y, width: u.width, height: u.height },
                                        u.strokeWidth / 2,
                                    );
                            }), !0)
                    );
                ...
                newText: function(e, t, n, a, i) {
                    var o, l, r, s, u, h;
                    return (
                        ((o = t.createElementNS(b, 'text')).textContent = e), [o.x, o.y].forEach(function(e) {
            ...
            pathLabel: {
                ...
                init: function(s, t) {
                    return (
                        'string' == typeof t.text && (s.text = t.text.trim()), !!s.text &&
